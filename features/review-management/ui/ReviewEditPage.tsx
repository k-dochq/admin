    ...
    <div className='space-y-6'>
      ...
      <div className='space-y-6'>
        ...
        <ContentSection
          ...
          concernsMultilingual={formData.concernsMultilingual}
          errors={errors}
          onUpdateTitle={(field: string, value: string) => updateNestedField('title', field, value)}
          onUpdateContent={(field: string, value: string) =>
            updateNestedField('content', field, value)
          }
          onUpdateConcernsMultilingual={(field: string, value: string) =>
