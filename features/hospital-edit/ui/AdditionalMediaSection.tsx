...
export function AdditionalMediaSection({ hospitalId }: AdditionalMediaSectionProps) {
  ...
  >({
    PROCEDURE_DETAIL: { ko_KR: [], en_US: [], th_TH: [], zh_TW: [], ja_JP: [], hi_IN: [], tl_PH: [] },
    VIDEO_THUMBNAIL: { ko_KR: [], en_US: [], th_TH: [], zh_TW: [], ja_JP: [], hi_IN: [], tl_PH: [] },
    VIDEO: { ko_KR: [], en_US: [], th_TH: [], zh_TW: [], ja_JP: [], hi_IN: [], tl_PH: [] },
  });
  ...
  const [uploading, setUploading] = useState<Record<MediaTabType, Record<HospitalLocale, boolean>>>(
    {
      ...
      VIDEO: { ko_KR: false, en_US: false, th_TH: false, zh_TW: false, ja_JP: false, hi_IN: false, tl_PH: false },
    },
  );
  ...
  >({
    ...
    VIDEO: { ko_KR: null, en_US: null, th_TH: null, zh_TW: null, ja_JP: null, hi_IN: null, tl_PH: null },
  });
  ...
  const handleUpload = useCallback(
    async (tab: MediaTabType) => {
      ...
      const locales: HospitalLocale[] = ALL_LOCALES;
  ...
  const handleSaveVideoLink = useCallback(async () => {
    ...
    try {
      ...
      const localizedLinks: LocalizedText = {
        ...
        tl_PH: videoLinks.tl_PH.trim() || undefined,
      };
                      ...
                      <div className='space-y-3'>
                        ...
                        <div className='space-y-2'>
                          <label className='text-muted-foreground text-xs'>
                            {HOSPITAL_LOCALE_LABELS.zh_TW} (zh_TW)
                          </label>
                          <Input
                            type='url'
                        ...
                        <div className='space-y-2'>
                          <label className='text-muted-foreground text-xs'>
                            {HOSPITAL_LOCALE_LABELS.ja_JP} (ja_JP)
                          </label>
                          <Input
                            type='url'
                            placeholder='https://example.com/video-ja'
                            value={videoLinks.ja_JP}
                            onChange={(e) =>
                              setVideoLinks((prev) => ({ ...prev, ja_JP: e.target.value }))
                            }
                          />
                        </div>
                        <div className='space-y-2'>
                        ...
                        <div className='space-y-2'>
                          <label className='text-muted-foreground text-xs'>
                            {HOSPITAL_LOCALE_LABELS.tl_PH} (tl_PH)
                          </label>
                          <Input
                            type='url'
                            placeholder='https://example.com/video-tl'
                            value={videoLinks.tl_PH}
                            onChange={(e) =>
                              setVideoLinks((prev) => ({ ...prev, tl_PH: e.target.value }))
                            }
                          />
                        </div>
                      </div>
