...
// 번역 결과 파일 경로
const TRANSLATION_FILE = path.join(__dirname, 'output/translated-notices-zh-tw.json');
 ...
 * 메인 업데이트 함수
 */
async function updateNoticesZhTW() {
  try {
    console.log('🔄 공지사항(Notice) 중국어 번체(zh-TW) 업데이트 작업 시작...');
