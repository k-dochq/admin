...
// 번역 결과 파일 경로
const TRANSLATION_FILE = path.join(__dirname, 'output/translated-notices-tl-ph.json');
 ...
 * 메인 업데이트 함수
 */
async function updateNoticesTlPH() {
  try {
    console.log('🔄 공지사항(Notice) 필리핀어(tl-PH) 업데이트 작업 시작...');
