...
// 번역 결과 파일 경로
const TRANSLATION_FILE = path.join(__dirname, 'output/translated-notices-hi-in.json');
 ...
 * 메인 업데이트 함수
 */
async function updateNoticesHiIN() {
  try {
    console.log('🔄 공지사항(Notice) 힌디어(hi-IN) 업데이트 작업 시작...');
